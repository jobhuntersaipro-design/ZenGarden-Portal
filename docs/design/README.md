...
https://claude.ai/code/artifact/43c584c8-b4b6-4479-8d0f-391ab44299ae
and linked from `CLAUDE.md`. The written companion is
`../specs/design/zengarden-portal-design.md`; the product-wide rules are in
...
| `zengarden-portal-canvas.html` | The publishable bundle: the canvas runtime with the artboards embedded as JSON. Generated — do not hand-edit. |
...
python3 rebuild.py      # folds artboards/ back into zengarden-portal-canvas.html
```

Then publish `zengarden-portal-canvas.html` to the artifact URL above, passing
