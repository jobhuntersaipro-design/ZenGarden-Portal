...
export type BuyerDocumentRow = {
  ...
  mimeType: string; sizeBytes: number; createdAt: Date; byLabel: string;   // "Uploaded by Aisha Rahman" | "Generated by Zen Garden"
